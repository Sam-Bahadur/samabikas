        ...
        <div className="text-mainblue mt-4 font-bold text-4xl">
            ...
            <div className="grid lg:grid-cols-2 gap-10  my-4 p-4 bg-gray-100">
                <form className="text-2xl">
                    ...
                    <input className="text-base ml-2 px-2 text-black  rounded-sm bg-blue-100" type="text" placeholder="Name"  />
                    </div>
                    <div  className="my-2 grid grid-cols-2">
                    <label className="text-black">Email :</label>
                    <input className="text-base ml-2 px-2 text-black  rounded-sm bg-blue-100" type="email" placeholder="email"  />
                    </div >
                    <div  className="my-2 grid grid-cols-2">
                    <label className="text-black">Phone :</label>
                    <input className="text-base ml-2 px-2 text-black  rounded-sm bg-blue-100" type="text" placeholder="Phone"  />
                    <label className="text-black">Message:</label>
                    <textarea className="text-base my-2 ml-2  px-2 text-black  rounded-sm bg-blue-100 h-40" placeholder="your message here"></textarea>
                    </div>
                    <div  className="my-2 grid grid-cols-2">
                        <div></div>
               ...
               <p className="text-mainblue text-2xl">
                Contact Address
               </p>
